object frameAdolescentes: TframeAdolescentes
  Left = 0
  Top = 0
  Width = 950
  Height = 631
  ...
  object FDQueryAdolescentes: TFDQuery
    ...
    SQL.Strings = (
        ...
        'SSIFICACAO = '#39'ADOLESCENTE'#39'order by NOME  ;'
      ''
      ''
      '')
    Left = 32
  ...
  object dsAdolescentes: TDataSource
    AutoEdit = False
    DataSet = FDQueryAdolescentes
    Left = 28
    Top = 114
  end
end
