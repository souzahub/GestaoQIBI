object frameInfantis: TframeInfantis
  Left = 0
  Top = 0
  Width = 897
  Height = 598
  ...
  object FDQueryInfantis: TFDQuery
    ...
    SQL.Strings = (
        ...
        'SSIFICACAO = '#39'INFANTIL'#39'order by NOME  ;'
      ''
      ''
      '')
    Left = 40
  ...
  object dsInfantis: TDataSource
    AutoEdit = False
    DataSet = FDQueryInfantis
    Left = 44
    Top = 122
  end
end
